...
async def follow(follow):
    ...
    await follow.edit(
                     ...
                     f"[InstaGram](https://www.instagram.com/royal_boy_priyanshu_420/) \n\n"
                     f"[FaceBook](https://www.facebook.com/priyanshu.barai.7) \n\n"
                     f"[YouTube](https://www.youtube.com/channel/UCSiHXm08lItOe0ogYiTbUlg) "
                     )    
